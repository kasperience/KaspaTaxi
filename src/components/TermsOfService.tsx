    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto p-6 bg-white my-8 rounded-lg shadow">
        ...
        <section className="mb-6">
          ...
          <p className="mb-4">If you have any questions about these Terms, please contact us at <a href="mailto:dev@KASperience.xyz" className="text-[#1ABC9C] hover:text-[#16a085] font-medium">dev@KASperience.xyz</a> or through the channels outlined in the <Link to="/contributing" className="text-[#1ABC9C] hover:text-[#16a085] font-medium">Contribution Guidelines</Link>.</p>
        </section>
      </main>
